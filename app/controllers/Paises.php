<?php
    ...
    class Paises extends Controlador{
        ...
        public function index(){
            ...
            //$last_updated = $this->paisModelo->get_last_updated();
            $last_updated = fechaCastellano($this->paisModelo->get_last_updated());
            
            $this->action = 'Listado de Paises';
        ...
        public function search(){
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST'){
                //
                //echo "search_nombre_pais: ".$_POST['search_nombre_pais'];
                ...
                $last_updated_tmp = $this->paisModelo->get_last_updated();
                $last_updated = fechaCastellano($this->paisModelo->get_last_updated());
