<?php
    /**
        ...
        * @version: 	2.3
        * el archivo originalmente se llama pdo_database.class.php -> renombrado a: Dbase.php
        * la clase originalmente se llama wArLeY_DBMS() -> renombrado a: class Dbase()
    */

    class Dbase{
        //Propiedades
        private $database_types = array("sqlite2",
                                        "sqlite3",
                                        "sqlsrv",
                                        "mssql",
                                        "mysql",
        ...
        */
        ...
        public function __construct(){
            ...
            $this->database_type = strtolower(DB_TYPE);
            $this->host = DB_SERVER;
            $this->database = DB_NAME;
            $this->user = DB_USER;
            $this->password = DB_PASS;
            $this->port = DB_PORT;
            //echo "<br>database_type: ".$this->database_type." host: ".$this->host;
            //die("");
        }
